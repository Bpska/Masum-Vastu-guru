...
const FloatingWhatsApp = () => {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-[9999] w-[60px] h-[60px] bg-yellow rounded-full flex items-center justify-center shadow-lg cursor-pointer group"
      title="Chat with us"
    >
      <motion.div
      ...
      >
        <svg viewBox="0 0 24 24" className="w-7 h-7 fill-maroon">
